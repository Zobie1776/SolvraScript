...
pub fn metadata() -> AppMetadata {
    ...
    let package = AppPackage::new(Version::new(1, 0, 0))
        ...
        .with_ui_component(
            ...
            .with_entry_point("novaslides::editor"),
        )
    ...
    AppMetadata::new(
        AppId::new("dev.nova.slides").expect("valid id"),
        "NovaSlides",
        "Design polished presentations with collaborative tooling",
        "NovaSlides focuses on fast slide composition, templating, and live presentation tools including timers and speaker notes.",
        AppCategory::Productivity,
        "Nova Labs",
        package,
    )
    .with_tag("presentations")
    .with_screenshot("screenshots/novaslides.png")
}
...
/// Slide elements supported by NovaSlides.
#[derive(Debug, Clone, PartialEq)]
