...
/// Primary entry point for interacting with the Nova App Store runtime.
#[derive(Debug)]
pub struct AppStore {
    catalog: Catalog,
...
impl AppStore {
    ...
    /// Register core Nova applications so the catalog is immediately useful.
...
mod tests {
    ...
    fn installs_builtin_applications() {
        ...
        let writer_id = AppId::new("dev.nova.writer").unwrap();
