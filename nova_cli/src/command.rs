//! Data structures describing parsed NovaCLI command pipelines.
...
pub enum Statement {
    ...
    Pipeline(Pipeline),
    /// A multi-line NovaScript block executed with the embedded interpreter.
    NovaBlock(String),
    /// A single-line NovaScript expression executed via the interpreter.
    NovaExpression(String),
