//! Rustyline helper providing NovaCLI completions and hints.
...
impl Helper for NovaHelper {}

impl Completer for NovaHelper {
    type Candidate = Pair;
...
impl Highlighter for NovaHelper {}

impl Validator for NovaHelper {
    fn validate(
        &self,
