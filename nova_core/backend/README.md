...
To exercise a backend run the NovaCore tests with the desired feature flag:

```bash
cargo test -p nova_core --no-default-features --features backend-aarch64
```
