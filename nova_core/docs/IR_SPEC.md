# NovaCore SSA Intermediate Representation

This document introduces the initial NovaCore SSA IR implemented in `src/backend/ir.rs`.
...
## Next Steps
- Lower Nova bytecode into this IR (`lowering.rs`).
- Expand opcode coverage for Nova bytecode operations.
