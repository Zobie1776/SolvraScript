# NovaCore Hardware Abstraction Layer

The NovaCore HAL (`sys::hal`) provides a device-agnostic facade for the runtime and backends.  It
introduces:
...
- **Telemetry integration** by reusing `RuntimeHooks`, ensuring NovaShell / NovaIDE receive
...
Policies are pluggable, allowing future Nova Security Plan components to provide hardened
...
constructs described in the Nova Security Plan.
