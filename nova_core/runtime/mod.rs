...
impl NovaRuntime {
    ...
    pub fn with_cost_limit(mut self, cost_limit: u64) -> crate::NovaResult<Self> {
        if cost_limit == 0 {
    ...
    pub fn enable_failsafe(&self, passphrase: &str) -> crate::NovaResult<()> {
        self.failsafe
            .enable(passphrase)
    ...
    pub fn authenticate(&self, passphrase: &str) -> crate::NovaResult<()> {
        self.failsafe.authenticate(passphrase)
    }

    /// Executes the provided bytecode.
    #[instrument(skip_all)]
    pub fn execute(&self, bytes: &[u8]) -> crate::NovaResult<Value> {
    ...
    pub fn load_module_file(&self, path: impl AsRef<Path>) -> crate::NovaResult<Arc<Module>> {
    ...
    pub fn register_driver(&self, descriptor: DriverDescriptor) -> crate::NovaResult<()> {
        self.drivers
