...
NovaIDE loads extensions from the `extensions/` directory. Each extension must provide an `extension.toml` manifest describing the plug-in name, entrypoint and capability set.
