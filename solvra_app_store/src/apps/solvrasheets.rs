...
/// Return catalog metadata for SolvraSheets.
pub fn metadata() -> AppMetadata {
    let sandbox = SandboxPolicy::new()
        ...
        .allow_storage_root("~/Documents/SolvraSheets");
    ...
    let package = AppPackage::new(Version::new(1, 0, 0))
        ...
        .with_ui_component(
            ...
            .with_entry_point("solvrasheets::grid"),
        );

    AppMetadata::new(
        AppId::new("dev.solvra.sheets").expect("valid id"),
        "SolvraSheets",
        "Flexible spreadsheet with formulas and chart-ready data",
        "SolvraSheets provides an opinionated yet powerful spreadsheet workflow with fast recalculation, CSV import/export, and integration hooks for SolvraScript automation.",
        AppCategory::Productivity,
        "Solvra Labs",
        package,
    )
    .with_tag("data")
    .with_screenshot("screenshots/solvrasheets.png")
}
