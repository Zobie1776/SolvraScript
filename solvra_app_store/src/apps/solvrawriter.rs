...
/// Return the catalog metadata for SolvraWriter.
pub fn metadata() -> AppMetadata {
    let sandbox = SandboxPolicy::new()
        ...
        .allow_storage_root("~/Documents/SolvraWriter");

    let package = AppPackage::new(Version::new(1, 0, 0))
        .with_sandbox(sandbox)
        .with_capability(
            AppCapability::new(
                "solvrawriter.document",
        ...
        .with_ui_component(
            ...
            .with_entry_point("solvrawriter::editor"),
        );

    AppMetadata::new(
        AppId::new("dev.solvra.writer").expect("valid app id"),
        "SolvraWriter",
        "Rich document editor for long-form writing",
        "SolvraWriter provides a distraction-free editing experience with styling, export, and collaboration hooks.",
    ...
    .with_screenshot("screenshots/solvrawriter.png")
}
...
/// Paragraph alignment options supported by SolvraWriter.
...
/// Represents a complete SolvraWriter document.
