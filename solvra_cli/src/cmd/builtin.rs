//! Built-in command implementations for SolvraCLI.
...
impl CommandHandler for Help {
    ...
    fn handle(
        ...
        for name in ctx
            .registry()
            .commands_by_kind(crate::registry::CommandKind::Solvra)
        {
            entries.push(format!("{} (solvra)", name));
        }
        entries.sort();
