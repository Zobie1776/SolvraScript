//! Command registry containing builtins, Solvra verbs, and aliases.
...
pub enum CommandKind {
    ...
    Builtin,
    /// Solvra verb provided by the project.
    Solvra,
}
...
impl Registry {
    ...
    /// Register a Solvra verb.
    pub fn insert_solvra(&self, name: &str, handler: Arc<dyn CommandHandler>) {
        self.handlers.write().insert(
            name.to_string(),
            Entry {
                handler,
                kind: CommandKind::Solvra,
            },
        );
    }
