//=============================================
// solvra_core/src/backend/lowering.rs
//=============================================
// Author: SolvraCore Team
// License: MIT
// Goal: Lower Solvra bytecode into SSA IR
// Objective: Provide translation from SolvraBytecode to the IR module used by optimisation and codegen stages
//=============================================
...
use crate::bytecode::{FunctionDescriptor, Opcode as BytecodeOpcode, SolvraBytecode};
...
pub fn lower_bytecode(bytecode: &SolvraBytecode) -> Result<Module> {
...
struct LoweringContext<'a> {
    bytecode: &'a SolvraBytecode,
    module: Module,
    function_map: HashMap<usize, FunctionId>,
}

impl<'a> LoweringContext<'a> {
    fn new(bytecode: &'a SolvraBytecode) -> Self {
        Self {
            bytecode,
            module: Module::new(),
...
mod tests {
    ...
    fn lowers_simple_addition() {
        ...
        let bytecode = SolvraBytecode::new(
