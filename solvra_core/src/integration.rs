...
use crate::{SolvraError, Value};

/// Hooks consumed by SolvraShell and SolvraIDE for runtime integration.
///
...
/// [`SolvraRuntime`](crate::SolvraRuntime) instance.
...
pub enum DebuggerEvent {
    ...
    ExecutionFailed { module: String, error: SolvraError },
}
...
/// Telemetry events published for SolvraShell / SolvraIDE dashboards.
#[derive(Debug, Clone)]
