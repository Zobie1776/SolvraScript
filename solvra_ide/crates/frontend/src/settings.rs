...
impl Default for IdeSettings {
    fn default() -> Self {
        Self {
            theme: "solvra-dark".to_string(),
            enable_solvra_ai: true,
            auto_save: true,
            font_size: 15.0,
...
impl SettingsStore {
    pub fn load_or_default() -> Self {
        let dirs = ProjectDirs::from("com", "Solvra", "SolvraIDE")
    ...
    pub fn solvra_ai_enabled(&self) -> bool {
        self.data.enable_solvra_ai
    }
}
