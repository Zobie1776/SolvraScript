...
echo
cat <<INSTRUCTIONS
To emulate SolvraLite on ARM64 via QEMU:
  1. Install the QEMU user static binaries package for your distribution.
  2. Ensure the built binary is located at target-arm64/${TARGET}/release/solvra_lite.
  3. Run: qemu-aarch64 -L /usr/aarch64-linux-gnu target-arm64/${TARGET}/release/solvra_lite
INSTRUCTIONS
