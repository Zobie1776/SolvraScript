...
impl LiteUiManager {
    ...
    pub async fn render_frame(
        ...
        let _output = self.context.run(raw_input, |ctx| {
            ...
            egui::TopBottomPanel::top("solvra_lite_toolbar").show(ctx, |ui| {
                ui.horizontal(|ui| {
                    ui.label("SolvraLite");
                    ui.separator();
                    ...
                    let ide_toggle = ToolbarAction {
                        label: "IDE".into(),
                        tooltip: "Toggle SolvraIDE panels".into(),
                    };
                    ...
                    let ai_toggle = ToolbarAction {
                        label: "SolvraAI".into(),
                        tooltip: "Toggle SolvraAI panel".into(),
                    };
