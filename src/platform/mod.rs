...
pub enum PlatformError {
    IoError(String),
    #[allow(dead_code)] // Reserved for richer platform error reporting.
    NotSupported(String),
    #[allow(dead_code)] // Reserved for richer platform error reporting.
    InvalidInput(String),
}
...
pub trait PlatformOps {
    ...
    #[allow(dead_code)] // Planned for future filesystem integrations.
    fn canonicalize_path(path: &str) -> PlatformResult<String>;
    fn sleep(duration: Duration);
    #[allow(dead_code)] // Exposed for embedded environments; unused in tests.
...
#[allow(dead_code)] // Exposed for host callers; not used in current tests.
